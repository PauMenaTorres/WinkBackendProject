...
### Architecture
The project is divided in different layers: models, repositories, services, routers and database and all its connected with FastAPI, MongoDB and Pydantic.
...
* **Core**: Contains the dependencies and custom exceptions for the application.
